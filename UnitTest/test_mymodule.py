...
class TestSquare(unittest.TestCase): 
    ...
    def test1(self): 
        ...
        # Verify that it handles float inputs.
...
class TestDouble(unittest.TestCase): 
    ...
    def test1(self): 
        ...
        # Verify that it handles negative float inputs.
        self.assertEqual(double(-3.1), -6.2) # test when -3.1 is given as input the output is -6.2.

        # Check that calling 'double(0)' returns 0.
        # Test edge case where input is zero.
...
class TestAdd(unittest.TestCase): 
    ...
    def test1(self): 
        self.assertEqual(add(2, 4), 6) # Test that adding 1 and 2 returns 3.
        self.assertEqual(add(0, 0), 0) 
        self.assertEqual(add(2.3, 3.6), 5.9)
        self.assertEqual(add("Hello", "World"), "HelloWorld") # Test that adding two strings concatenates them.
        self.assertEqual(add(2.30000, 4.300), 6.6)
        self.assertNotEqual(add(-2, -2), 0) # Test that adding two negative numbers does not return zero.
